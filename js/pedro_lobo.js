let JSON_CUENTO = {
  ...
  tipo: 'Cuento sobre honestidad y responsabilidad',
  descripcion:
    'Pedro es un niño al que no le gusta su trabajo: pasa los días pastoreando a sus ovejas de un lado para otro. Una tarde se le ocurre hacer una mala broma y asustar a los habitantes del pueblo, que alarmados, corren a ayudarlo. Se molestan muchísimo cuando descubren que no es más que una travesura del niño. ¿Cuántas veces más acudirán en su ayuda los vecinos?',
  creditos: [
    ['Adaptación:', 'Copec'],
    ['Ilustraciones:', 'Copec'],
  ...
  fx_sonido: [
    {
      nombre: 'musica_pastoril_loop',
      url: 'audio/pedro_lobo/fx/musica_pastoril_loop.mp3',
    },
    ...
    {
      nombre: 'lobo_pataleando',
      url: 'audio/pedro_lobo/fx/lobo_pataleando.mp3',
    },
  ...
  escenas: [
    {
      ...
      parrafos: [
        {
          texto:
            'En un pequeño pueblo entre las montañas, vivía un niño llamado Pedro,',
          tiempo: [0, 7.7, 15],
        },
        {
          texto:
            'quien ayudaba a sus padres cuidando a las ovejas después de la escuela.',
          tiempo: [8.2, 13.8, 0.5],
        },
      ],
    },
    {
      ...
      parrafos: [
        ...
        {
          texto:
            'Debía buscar pastos verdes para las ovejas y acompañarlas mientras pastaban.',
          tiempo: [3.7, 10.3, 0.5],
        },
        {
    ...
    },
    {
      ...
      parrafos: [
        {
          texto:
            'Pedro pensaba que era una pérdida de tiempo llevar a las ovejas de un lado a otro cuando ellas podían hacerlo solas.',
          tiempo: [0, 9.6, 3],
        },
        {
          texto:
            'Mientras cuidaba a sus ovejas, pensó que sería divertido jugar una broma a los vecinos del pueblo.',
          tiempo: [10.1, 19.2, 1.1],
        },
        {
          texto:
            'Tomó aire y gritó lo más fuerte que pudo: “¡Ayuda, que viene el lobo y me come!”',
          tiempo: [19.5, 31, 2],
        },
        {
          texto:
            'Cerro arriba partieron los vecinos armados de palos y herramientas para proteger a Pedro y su rebaño.',
          tiempo: [31.5, 41.2, 3],
        },
        {
          texto:
            'Grande fue su disgusto cuando lo encontraron tan feliz y campante.',
          tiempo: [41.7, 48.5, 6],
        },
        {
          texto:
            '“Pedrito - le dijo el panadero - temimos por tu vida. No lo vuelvas a hacer.”',
          tiempo: [49, 56.7, 1.7],
        },
        {
        ...
        {
          texto:
            'Una tarde, mientras Pedro dormía bajo un árbol, las ovejas comenzaron a balar.',
        ...
        {
          texto:
            'Corrió cerro abajo gritando: “¡Auxilio, socorro, que el lobo me come!” Pero ya nadie le creía, así que nadie lo ayudó.',
          tiempo: [84, 99, 1],
        },
      ],
    },
    {
      ...
      parrafos: [
        {
          texto:
            'Pedro llegó hasta el mismísimo pueblo dando gritos y corriendo con el lobo pisándole los talones.',
          tiempo: [0, 8.1, 2],
        },
        {
    ...
    },
    {
      ...
      parrafos: [
        ...
        {
          texto:
            '“Pedrito, tuviste suerte. El lobo se comió a varias de nuestras ovejas y podría haberte comido a ti” -le dijo su papá.',
          tiempo: [5.9, 16.6, 1.2],
        },
        {
          texto:
            '“Espero que hayas aprendido por qué no debes decir mentiras.”',
          tiempo: [17.1, 22.4, 0.8],
        },
        {
          texto:
            '“Desde hoy vigilaré desde la colina <br> y traeré a cada oveja perdida en la neblina.”',
          tiempo: [23.2, 29.2, 0.5],
        },
        {
          texto:
            '“Aprendí a respetar al lobo rabioso y jamás volveré a ser mentiroso.”',
          tiempo: [29.7, 36.8],
        },
      ],
    },
...
let ANIM = {
  ...
  pauseAnimaciones: () => {
    ...
    try {
      ANIM.anim_rebano_01.pause(0);
    } catch (err) {}
    try {
      TweenMax.killTweensOf('#escena_01 .pajarito.amarillo', {
        x: true,
        y: true,
        scaleX: true,
        scaleY: true,
    ...
    try {
      TweenMax.killTweensOf('#escena_01 .pajarito.azul', {
        x: true,
        y: true,
        scaleX: true,
        scaleY: true,
    ...
    try {
      ANIM.anim_sol_01.pause();
    } catch (err) {}
    try {
      ANIM.anim_sol_02.pause();
    } catch (err) {}
    try {
      ANIM.anim_mejilla_02.pause();
    } catch (err) {}
    try {
      ANIM.tl_jo_lobo.pause();
    } catch (err) {}
    try {
      ANIM.tl_boca_04.pause();
    } catch (err) {}
    try {
      ANIM.tl_ojo_1.pause();
    } catch (err) {}
  ...
  getTlAnimacionesSprite: (
    ...
    if (!ANIM[`tl_${clase}_${escena}`]) {
      ...
      ANIM[`tl_${clase}_${escena}`]
        .fromTo(
          `#escena_${escena} .${clase}`,
          timeOn,
          { backgroundPosition: '0% 0%' },
          {
            backgroundPosition: `-${(frames - 1) * 100}% 0%`,
      ...
      ANIM.arrAnimacionesSprite.push({
        name: `tl_${clase}_${escena}`,
        tl: ANIM[`tl_${clase}_${escena}`],
      });
    }
  ...
  creaElementos: (arr1, arr2, clase, claseAdicional = '') => {
    ...
    let newArr = arr1.map((item, i) => {
      ...
      let letra = arr2[j];
      return `<div class="${claseAdicional} ${clase} ${clase}${letra} ${clase}${
        i + 1
      }"></div>`;
    });
    return newArr.join('');
  ...
  animaEscena0: () => {
    let barba = ANIM.getTlAnimacionesSprite(
      '00',
      'barba',
      2,
      Utils.randomInt(30, 50) / 100
    );
    barba.resume();
    let bigote1 = ANIM.getTlAnimacionesSprite(
      '00',
      'bigote1',
      2,
      Utils.randomInt(30, 50) / 100
    ...
    bigote1.resume();
    let bigote2 = ANIM.getTlAnimacionesSprite(
      '00',
      'bigote2',
      2,
      Utils.randomInt(30, 50) / 100
    ...
    bigote2.resume();
    let dama = ANIM.getTlAnimacionesSprite(
      '00',
      'dama',
      2,
      Utils.randomInt(30, 50) / 100
  ...
  animaEscena1: () => {
    ...
    let vals = keyFrames.map((item, i) => {
      return {
        ...
        zIndex: item.zIndex,
        rotation: parseFloat(
          item.transform.replace('rotate(', '').replace('deg)', '')
        ),
      };
    });
    ...
    let mueveLasPatas = () => {
      rebano.map((item, i) => {
        let camina = ANIM.getTlAnimacionesSprite(
          '01',
          item,
          2,
          Utils.randomInt(30, 70) / 100
        );
        camina.resume();
      });
    };
    if (!ANIM.anim_rebano_01) {
      ANIM.anim_rebano_01 = new TimelineMax({
        repeat: -1,
        onStart: function () {
          mueveLasPatas();
        },
      ...
      rebano.map((item, i) => {
        ...
        temp
          ...
          .to(`#escena_01 .${item}`, 18, {
            bezier: {
              curviness: 0.25,
              autoRotate: false,
              values: vals.slice(0, 6),
            },
            ease: Power0.easeNone,
          })
          .set(`#escena_01 .${item}`,{x:vals[7].x, y:vals[7].y, rotation:vals[7].rotation, zIndex:vals[7].zIndex})
          .to(`#escena_01 .${item}`, 24, {
            bezier: {
              curviness: 0.25,
              autoRotate: false,
              values: vals.slice(8),
        ...
        ANIM.anim_rebano_01.add(temp, i*2);
      });
    }
    if (ANIM.anim_rebano_01.paused()) {
      ANIM.anim_rebano_01.resume(0);
    } else {
      ANIM.anim_rebano_01.resume();
    }
//    ANIM.anim_rebano_01.timeScale(0.5);
    ...
    if (!ANIM.anim_sol_01) {
      ...
      ANIM.anim_sol_01.to('#escena_01 .sol', 2, {
        scale: 2,
        repeat: 1,
        yoyo: true,
      });
  ...
  animaEscena2: () => {
    ...
    if (!ANIM.anim_sol_02) {
      ...
      ANIM.anim_sol_02.to('#escena_02 .sol', 2, {
        scale: 2,
        repeat: 1,
        yoyo: true,
      });
    ...
    if (!ANIM.anim_mejilla_02) {
      ...
      ANIM.anim_mejilla_02.fromTo(
        '#escena_02 .oveja .masca',
        0.7,
        { scale: 0.7 },
        { scale: 0.6, transformOrigin: 'bottom left', repeat: 15, yoyo: true }
      );
    }
  ...
  animaMariposa: (cualEscena = 'escena_01', maxY = 700) => {
    ...
    TweenMax.to(`#${cualEscena} .mariposa`, t, {
      bezier: {
        curviness: 1.25,
        autoRotate: true,
      ...
      onComplete: function (a, b) {
        ANIM.animaMariposa(a, b);
      },
      onCompleteParams: [cualEscena, maxY],
    });
  },
  animaPajarito: (cualEscena = '01') => {
    let tweensActives = TweenMax.getTweensOf(
      `#escena_${cualEscena} .pajarito.amarillo`,
      true
    );
    let tweensActives2 = TweenMax.getTweensOf(
      `#escena_${cualEscena} .pajarito.azul`,
      true
    );
    if (tweensActives.length === 0 && tweensActives2.length === 0) {
      ...
      let aleteo = ANIM.getTlAnimacionesSprite(
        `${cualEscena}`,
        `pajarito`,
        2,
        0.5
      ...
      TweenMax.fromTo(
        `#escena_${cualEscena} .pajarito.${cual}`,
        t,
        { x: fromX, y: fromY, scaleX: scale * dir, scaleY: scale },
        {
          x: toX,
          y: toY,
          scaleX: scale * dir,
  ...
  subeCerro: (cual, keyframes, lastPOS, t = 5) => {
    ...
    return TweenMax.to(`#escena_02 .${cual}`, t, {
      bezier: {
        curviness: 0.25,
        autoRotate: false,
        values: arrFinal,
  ...
  bajaCerro: (cual, keyframes, lastPOS, zIndex) => {
    ...
    return TweenMax.to(`#escena_02 .${cual}`, 3, {
      bezier: {
        curviness: 0.25,
        autoRotate: false,
        values: arrFinal,
  ...
  init: () => {
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_00 .caballo', 6, {
        x: -600,
        y: -60,
        onStart: function () {
    ...
    $('#escena_00 .oveja').each(function (i) {
      ANIM.main_tl.add(
        TweenMax.from(`#escena_00 .oveja${ANIM.arrLetras[i]}`, 14, {
          x: Utils.randomInt(2500, 2900),
          onStart: function () {
            let camina = ANIM.getTlAnimacionesSprite(
              '00',
              `oveja${ANIM.arrLetras[i]}`,
              2,
              Utils.randomInt(30, 70) / 100
            );
            camina.resume(0);
    ...
    ANIM.main_tl.add(
      TweenMax.from(`#escena_00 .pedro`, 14, {
        x: Utils.randomInt(2500, 2900),
        onStart: function () {
          let camina = ANIM.getTlAnimacionesSprite(
            '00',
    ...
    ANIM.main_tl.add(
      TweenMax.from(`#escena_00 .perro`, 14, {
        x: Utils.randomInt(2500, 2900),
        onStart: function () {
          let camina = ANIM.getTlAnimacionesSprite(
            '00',
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_00 .rebano', 6, { y: -130 }),
      '0_1-=0.4'
    );
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .bigote1', {
        x: 1920,
        y: 880,
        scaleX: 1.4,
        scaleY: 1.4,
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .bigote2', {
        x: 1920,
        y: 880,
        scaleX: 1.4,
        scaleY: 1.4,
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .bigote3', {
        x: 1920,
        y: 880,
        scaleX: 1.4,
        scaleY: 1.4,
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .humito', { alpha: 0 }),
      'escena_2-=0.4'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .pedroC', { alpha: 0 }),
      'escena_2-=0.4'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .perroC', {
        alpha: 0,
        scaleX: -1.4,
        scaleY: 1.4,
      }),
    ...
    //llamado1
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .pedroA', 0.1, { alpha: 0 }),
      '2_2+=5'
    );
    ANIM.main_tl.add(
      TweenMax.fromTo('#escena_02 .pedroB', 0.1, { alpha: 0 }, { alpha: 1 }),
      '2_2+=5'
    );
    ANIM.main_tl.addCallback(function () {
      let grita = ANIM.getTlAnimacionesSprite(
        '02',
        'pedroB',
        2,
        0.2,
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .pedroB', 0.1, { alpha: 0 }),
      '2_3-=3.5'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .pedroA', 0.1, { alpha: 1 }),
      '2_3-=3.5'
    );
    ...
    ANIM.main_tl.add(
      ANIM.subeCerro('bigote3', keyframes, { x: 400, y: 200, rotation: 0 }),
      '2_3+=9.7'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('dama', keyframes, { x: 410, y: 220, rotation: 0 }),
      '2_3+=9.8'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('barba', keyframes, { x: 490, y: 230, rotation: 0 }),
      '2_3+=9.9'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('bigote1', keyframes, { x: 500, y: 210, rotation: 0 }),
      '2_3+=10'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('bigote2', keyframes, { x: 500, y: 250, rotation: 0 }),
      '2_3+=10.1'
    );
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .perroA', 0.1, { alpha: 0 }),
      '2_5-=1.5'
    );
    ANIM.main_tl.addCallback(function () {
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .pedroA', 0.1, {
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .perroA', 0.1, { alpha: 1 }),
      '2_5+=0.1'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .bigote3', 0.2, {
        y: 195,
        yoyo: true,
        repeat: 5,
      }),
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .bigote1', { scaleX: -1.4, scaleY: 1.4 }),
      '2_5+=7.8'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .bigote2', { scaleX: -1.4, scaleY: 1.4 }),
      '2_5+=7.8'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .bigote3', { scaleX: -1.4, scaleY: 1.4 }),
      '2_5+=7.8'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .barba', { scaleX: -1.4, scaleY: 1.4 }),
      '2_5+=7.8'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_02 .dama', { scaleX: -1.4, scaleY: 1.4 }),
      '2_5+=7.8'
    );
    ANIM.main_tl.add(
      ANIM.bajaCerro('bigote3', keyframes, { x: 400, y: 200, rotation: 0 }, 7),
      '2_5+=7.8'
    );
    ANIM.main_tl.add(
      ANIM.bajaCerro('barba', keyframes, { x: 490, y: 230, rotation: 0 }, 6),
      '2_5+=8.2'
    );
    ANIM.main_tl.add(
      ANIM.bajaCerro('bigote2', keyframes, { x: 500, y: 250, rotation: 0 }, 5),
      '2_5+=8.4'
    );
    ANIM.main_tl.add(
      ANIM.bajaCerro('dama', keyframes, { x: 410, y: 220, rotation: 0 }, 4),
      '2_5+=8.6'
    );
    ANIM.main_tl.add(
      ANIM.bajaCerro('bigote1', keyframes, { x: 500, y: 210, rotation: 0 }, 3),
      '2_5+=8.8'
    );
    ...
    ANIM.main_tl.add(
      ANIM.subeCerro('bigote3', keyframes, { x: 400, y: 200, rotation: 0 }, 2),
      '2_7+=5.5'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('dama', keyframes, { x: 410, y: 220, rotation: 0 }, 2),
      '2_7+=5.6'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('barba', keyframes, { x: 490, y: 230, rotation: 0 }, 2),
      '2_7+=5.7'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('bigote1', keyframes, { x: 500, y: 210, rotation: 0 }, 2),
      '2_7+=5.8'
    );
    ANIM.main_tl.add(
      ANIM.subeCerro('bigote2', keyframes, { x: 500, y: 250, rotation: 0 }, 2),
      '2_7+=5.9'
    );
    ...
    //        },'2_8+=5.5');
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .lobo', 3, { x: 980, y: 850, rotation: 20 }),
      '2_8+=1'
    );
    ANIM.main_tl.add(
      TweenMax.fromTo(
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .lobo', 1.7, {
        x: 700,
        y: 440,
        ease: Power0.easeNone,
      }),
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .lobo', 0.7, { rotation: 55 }),
      '2_8+=5'
    );
    //LOBO ataca
    ANIM.main_tl.add(
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .lobo', 0.5, { x: 70, y: 280, rotation: -5 }),
      '2_9+=5.75'
    );
    ANIM.main_tl.add(
      TweenMax.fromTo(
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .lobo', 0.02, { scaleX: 1.4 }),
      '2_9+=6.1'
    );
    //lobo corre abajo
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .lobo', 6, {
        bezier: {
          curviness: 0.25,
          autoRotate: false,
          values: [
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .perroA', 0.1, {
        backgroundPosition: '0% -100%',
        ease: SteppedEase.config(1),
        immediateRender: false,
      }),
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .humito', 0.1, { alpha: 1 }),
      '2_9+=5.9'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .humito', 1, { alpha: 0, scale: 0.7 }),
      '2_9+=6'
    );

    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .pedroC', 0.1, { alpha: 1 }),
      '2_9+=5.9'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .perroC', 0.1, { alpha: 1 }),
      '2_9+=5.9'
    );

    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .perroC', 8.5, {
        bezier: {
          curviness: 1.25,
          autoRotate: false,
          values: [
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .pedroC', 7.5, {
        bezier: {
          curviness: 1.25,
          autoRotate: false,
          values: [
    ...
    //Ovejas se asustan
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 0.03, {
        backgroundPosition: '0% 0%',
        ease: SteppedEase.config(1),
      }),
      '2_8+=3'
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 0.03, { scaleX: 0.8 }),
      '2_8+=3'
    );

    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaB', 0.03, {
        backgroundPosition: '0% 0%',
        ease: SteppedEase.config(1),
      }),
      '2_8+=5.3'
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaA', 0.03, {
        backgroundPosition: '0% 0%',
        ease: SteppedEase.config(1),
      }),
      '2_8+=7'
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaA', 0.03, { scaleX: 0.8 }),
      '2_8+=7'
    );
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 0.2, {
        backgroundPosition: '0% -100%',
        ease: SteppedEase.config(1),
        repeat: 3,
        yoyo: true,
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 1, { x: 700, ease: Sine.easeOut }),
      '2_8+=6.1'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 6, { x: 800, ease: Power0.easeNone }),
      '2_8+=7.1'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 1, { x: 1200, ease: Sine.easeIn }),
      '2_8+=13.1'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaC', 0.2, {
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaB', 0.7, {
        x: 600,
        y: 160,
        ease: Sine.easeOut,
      }),
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaB', 6, { x: 700, ease: Power0.easeNone }),
      '2_8+=7.1'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaB', 1.5, { x: 1500, ease: Sine.easeIn }),
      '2_8+=13.1'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaB', 0.2, {
        backgroundPosition: '0% -100%',
        ease: SteppedEase.config(1),
        repeat: 7,
        yoyo: true,
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaA', 0.2, {
        backgroundPosition: '0% -100%',
        ease: SteppedEase.config(1),
        repeat: 31,
        yoyo: true,
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_02 .ovejaA', 1, {
        x: 400,
        y: 400,
        ease: Sine.easeIn,
      }),
    ...
    //set zoom
    ANIM.main_tl.add(
      TweenMax.set('#escena_03', { scale: 3.3, x: 2200, y: 100 }),
      'escena_3+=0.01'
    );
    //set lobo corre
    ANIM.main_tl.add(
      TweenMax.set('#escena_03 .lobo_corre', {
        scaleX: -0.3,
        scaleY: 0.3,
    ...
    //escala zorro
    ANIM.main_tl.add(
      TweenMax.to('#escena_03 .lobo_corre', 8, {
        scaleX: -0.4,
        scaleY: 0.4,
        transformOrigin: 'top left',
      }),
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_03 .humo', { x: 0, y: 0, scale: 0, alpha: 0.3 }),
      '3_1+=0.1'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_03 .lobo .ojo', { alpha: 0 }),
      '3_1+=0.1'
    );
    ANIM.main_tl.add(
      TweenMax.staggerTo(
        '#escena_03 .humo',
        0.9,
        { x: -100, y: 0, scale: 0.5, alpha: 0, ease: Sine.easeOut },
        0.3
      ),
      '3_1+=0.2'
    );
    ANIM.main_tl.add(
      TweenMax.from('#escena_03 .lobo', 5, {
        x: -1400,
        ease: Power2.easeOut,
        onStart: function () {
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_03 .lobo .ojo', 0.1, { alpha: 1 }),
      '3_1+=1'
    );
    ANIM.main_tl.addCallback(function () {
      ANIM.animaOjoLobo();
    ...
    ANIM.main_tl.add(
      TweenMax.to('#escena_00', 0.1, { left: '0px' }),
      'escena_5-=0.2'
    );
    ANIM.main_tl.add(
      TweenMax.set('#escena_00 .caballo', {
        x: 0,
        y: 0,
        immediateRender: false,
      }),
    ...
    $('#escena_00 .oveja').each(function (i) {
      ANIM.main_tl.add(
        TweenMax.set(`#escena_00 .oveja${ANIM.arrLetras[i]}`, {
          x: Utils.randomInt(2500, 2900),
        }),
        'escena_5+=0.01'
      );
      ANIM.main_tl.add(
        TweenMax.to(`#escena_00 .oveja${ANIM.arrLetras[i]}`, 12, {
          x: 0,
          onStart: function () {
            let camina = ANIM.getTlAnimacionesSprite(
              '00',
    ...
    ANIM.main_tl.add(
      TweenMax.set(`#escena_00 .pedro`, { x: Utils.randomInt(2500, 2900) }),
      'escena_5-=10'
    );
    ANIM.main_tl.add(
      TweenMax.to(`#escena_00 .pedro`, 12, {
        x: 0,
        onStart: function () {
          let camina = ANIM.getTlAnimacionesSprite(
            '00',
    ...
    ANIM.main_tl.add(
      TweenMax.set(`#escena_00 .perro`, { x: Utils.randomInt(2500, 2900) }),
      'escena_5-=10'
    );
    ANIM.main_tl.add(
      TweenMax.to(`#escena_00 .perro`, 12, {
        x: 0,
        onStart: function () {
          let camina = ANIM.getTlAnimacionesSprite(
            '00',
    ...
    ANIM.main_tl.add(
      TweenMax.set('#escena_00 .rebano', { y: 0 }),
      'escena_5-=10'
    );
    ANIM.main_tl.add(
      TweenMax.to('#escena_00 .rebano', 6, { y: -130 }),
    ...
    ANIM.main_tl.addCallback(function () {
      ...
      ANIM.waitForSound(
        'ovejas_balan',
        Utils.randomInt(0, 50) / 10,
        5.8,
        0,
        Utils.randomInt(1, 90) / 10
      );
      ANIM.waitForSound(
        'perro_ladra',
        Utils.randomInt(0, 90) / 10,
        1.3,
        0,
        Utils.randomInt(1, 190) / 10
      );
      ANIM.main_tl.pause();
      Player.activaBtnSiguiente();
    ...
    switch (nEscena) {
      ...
      case 1:
        if (btn.hasClass('primario')) {
          btn.click(function () {
            ...
            ANIM.anim_interact_1.eventCallback('onComplete', muestralo, [
              $(this),
              cb,
            ]);
      ...
      case 2:
        if (btn.hasClass('btn_cejas')) {
          btn.click(function () {
            $(this).css({ display: 'none' });
            ANIM.anim_interact_2_cejas.eventCallback('onComplete', muestralo, [
              $(this),
              cb,
            ]);
        ...
        if (btn.hasClass('btn_gatos')) {
          btn.click(function () {
            $(this).css({ display: 'none' });
            ANIM.anim_interact_2_duendes.eventCallback(
              'onComplete',
              muestralo,
              [$(this), cb]
            );
